...
public class CodZonasDaoImpl implements CodZonasDao {
	...
	private static String INS_ZONA = "Insert into COD_ZONAS Values(NULL,UPPER(?))"; 
	private static String DEL_ZONA = "Delete from COD_ZONAS where id_zona= ?";
	private static String UPD_ZONA = "Update COD_ZONAS set descripcion = UPPER(?) where id_zona= ?";
	
	private static String TODOS = "Select * from COD_ZONAS order by descripcion"; 
	private static String TODOS_POR_ID = "Select * from COD_ZONAS Where id_zona=?"; 
	private static String TODOS_POR_DESCRIPCION = "Select * from COD_ZONAS Where descripcion= UPPER ( ? )";
	private static String TODOS_POR_DESCRIPCION_LIKE = "Select * from COD_ZONAS Where descripcion LIKE UPPER( '%' || ? || '%')";
