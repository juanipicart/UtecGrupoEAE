...
public class ObservacionDaoImpl implements ObservacionDao{
	...
	@Override
	public boolean buscarObsPorFenomeno(String fenomeno) throws Exception {
		
		String ObsPorFenomeno = "Select * from REL_OBS_FEN_CARACTERISTICAS where ID_FENOMENO = ?";
		
		Fenomeno fenom = fenomenoDao.selectFenomenoPorNombre(fenomeno);
		Long id = fenom.getId_fenomeno();
